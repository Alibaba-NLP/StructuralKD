...
class PTB_SL(ColumnCorpus):
    def __init__(self,
        ...
        """
        Initialize the PTB corpus which is coverted to sequence labeling format. This is only possible if you've manually downloaded it to your machine.

        :param base_path: Path to the PTB corpus on your machine
        ...
        super(PTB_SL, self).__init__(
            data_folder, columns, train_file, test_file, dev_file, in_memory=in_memory
        )
# =================================For dependency parsing as sequence labeling==============================
...
class PTB(Corpus):
    def __init__(self, treebank: str = None, base_path: Union[str, Path] = None, in_memory: bool = True, add_root: bool = True, tag_to_bioes=None):
        ...
        train = UniversalDependenciesDataset(data_folder/'train_modified.bllip.100000.tsv.conllu', in_memory=in_memory, add_root=True)
