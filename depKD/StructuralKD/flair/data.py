...
class Sentence(DataPoint):
    ...
    def set_teacher_posteriors(self, vector, storage_mode):
        self._teacher_posteriors.append(vector[:len(self)].to(storage_mode, non_blocking=True))
    ...
    def get_teacher_sl_posteriors(self) -> torch.tensor:
        return self._teacher_posteriors[0].to(flair.device)
